...
namespace NinjaTools{
    ...
    public static class Utils {
        ...
        public static object WaitForSeconds(float v1, float v2=0) {
            float waitAmount = v1;
            if(v2!=0) {
              waitAmount = Random.Range(v1, v2);  
              logd("WaitForSeconds","WaitAmount="+waitAmount);
            }
            return new WaitForSeconds(waitAmount);
        }
